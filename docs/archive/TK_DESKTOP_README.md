# Historical Tk Desktop README — not current launch/release instructions

Preserved before Tkinter Retirement. References below to main.py, requirements,
packaging and production UI describe the retired entrypoint. For explicit
compatibility use see ../../legacy/README.md; for the product see ../../README.md.
